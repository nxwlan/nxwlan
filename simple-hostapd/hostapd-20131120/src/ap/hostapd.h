...
#if  defined(CLIENT_BLACKLISTING) || defined(STA_CAPA_COLLECT)
...
struct sta_capa_entry {
	struct dl_list list;
	u8 mac[6];
	u8 probe_fiveghz_rec;
	u8 probe_twoghz_rec;
...
#ifdef CLIENT_BLACKLISTING
	char *blacklist_mac;
	struct dl_list *blacklisted_macs_list;
#endif /*CLIENT_BLACKLISTING*/

#ifdef STA_CAPA_COLLECT
	struct dl_list *sta_capa_list;
	int sta_capa_count;
#endif /*STA_CAPA_COLLECT*/
