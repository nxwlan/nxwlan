...
#ifdef BIGAP_DYN_CHAN_SWITCH		
	struct dfs_event fake_dfs_event;
	fake_dfs_event.freq = 5240;
	fake_dfs_event.ht_enabled=1;
	fake_dfs_event.chan_offset=0;
	fake_dfs_event.chan_width=CHAN_WIDTH_20;
	fake_dfs_event.cf1=5220;
	fake_dfs_event.cf2=5220;
#endif	
	int level = MSG_DEBUG;
...
#ifdef BIGAP_DYN_CHAN_SWITCH		
			printf("SCANRESULT CALLBACK CALLED!!");
			hostapd_event_dfs_radar_detected(hapd, &fake_dfs_event);
#endif		
