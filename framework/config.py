...
KEYCHANGEINTERVAL = 6000 # seconds min 10
CHANNEL_SWITCH_GUARD = 2 # to protect channel switch

# GENERAL CONFIG
if socket.gethostname()== "pamela":
    WIRED_INTERFACE = "enp3s0" # backhauling interface
elif socket.gethostname()=="chlamydia":
    WIRED_INTERFACE = "enp2s5"
elif socket.gethostname()=="erdogan":
